  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/game" element={<Game setOtherPlayerName={setOtherPlayerName} otherPlayerName={otherPlayerName}  xo={xo} setXO={setXO} myTurn={myTurn} setMyTurn={setMyTurn} name={name} roomID={roomID} />} />
      </Routes>
    </BrowserRouter>
    </context.Provider>
  );
